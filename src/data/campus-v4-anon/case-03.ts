...
import portrait from "../../assets/campus-v4-public/case-03-portrait-safe.webp";

/**
 * Campus V4 — ANONYMIZED mirror profile for case-03 (commerce MD · growth).
 *
 * Same rules as case-02: authored, fully de-identified, never derived from the
 * real customer at build time. Every employer, platform, seller, brand, exact
 * date, region, and the person's name is removed or generalized; contact is
 * empty; the portrait is the mosaicked safe asset. The real profile
 * (/profiles/yesol/) is untouched and not imported here. Theme/layout kept so
 * the mirror matches the sanitized card screenshot.
 */
export const profile: CampusAnonProfile = {
  ...
  seo: {
    title: "지원자 C | 커머스 MD · 그로스 마케팅",
    description:
      "데이터 기반 상품 기획과 프로모션으로 커머스 브랜드의 매출 성장을 이끄는 커머스 MD·그로스 마케팅 직무 지원자의 익명 사례입니다.",
  },

  person: {
    name: "지원자 C",
    englishName: "APPLICANT C",
    roleLine: {
      ko: "커머스 MD · 그로스 마케터",
    ...
    summary: {
      ko: "커머스 영역에서 상품 기획부터 프로모션, 광고 운영, 상세페이지 디렉션까지 브랜드 운영 전반을 담당해온 MD이자 그로스 마케터입니다. 손익 분석과 성과 데이터를 근거로 프로모션을 설계하고 ROAS·객단가·재고 회전을 함께 끌어올립니다.",
      en: "An MD and growth marketer who runs brand operations end to end — product planning, promotions, ad operations, and detail-page direction — across commerce. Every promotion is built from P&L and performance data to lift ROAS, average order value, and inventory turns together.",
    },
    identitySupport: {
      ko: "현재 국내 종합 커머스 플랫폼에서 입점 브랜드의 거래액 성장을 담당하며, 이전에는 글로벌 뷰티 커머스와 증권사 재경팀에서 데이터 기반 운영과 정합성 관리를 경험했습니다.",
      en: "Currently driving GMV growth for onboarded brands at a commerce platform, after data-driven operations in global beauty commerce and financial-close work at a securities firm.",
    },
    photo: {
      src: portrait.src,
      alt: "지원자 C 프로필 — 얼굴 비공개 처리",
    },
  },
  ...
  experiences: [
    {
      company: { ko: "국내 종합 커머스 플랫폼", en: "Commerce Platform" },
      role: "Merchandising Associate",
      period: "재직 중",
      description: {
        ko: "플랫폼 입점 브랜드의 거래액 성장과 프로모션 운영을 담당하는 커머스 MD.",
        en: "Commerce MD driving GMV growth and promotions for brands onboarded to the platform.",
      },
      bullets: [
        {
        ...
        {
          ko: "주요 입점 셀러 거래액 극대화 — 첫 컨택 후 규모 68배 이상 확대",
          en: "Maximized key seller GMV — 68×+ scale after first contact",
        },
        {
          ko: "하루특가·기획전 프로모션으로 주요 카테고리 TOP3 진입",
        ...
        {
          ko: "사내 월간 실적 리뷰에서 딜당 거래액 최우수자 선정 및 성장 노하우 발표",
          en: "Named top performer for GMV-per-deal in a monthly performance review and presented growth know-how",
        },
      ],
    },
    {
      company: { ko: "글로벌 뷰티 커머스", en: "Global Beauty Commerce" },
      role: { ko: "글로벌팀 MD 인턴", en: "Global Team MD Intern" },
      period: "약 4개월",
      description: {
        ko: "글로벌 뷰티 커머스에서 상품 기획, 광고 운영, 상세페이지 현지화를 담당.",
        en: "Product planning, ad operations, and detail-page localization for global beauty commerce.",
      },
      bullets: [
        {
        ...
        {
          ko: "글로벌 오픈마켓 광고 운영으로 ROAS 86%→166% 개선",
          en: "Ran marketplace ads, improving ROAS from 86% to 166%",
        },
        {
        ...
        {
          ko: "해외 유저 타겟 상세페이지 기획 및 현지화 번역",
          en: "Planned and localized detail pages for overseas users",
        },
      ],
    },
    {
      company: { ko: "국내 증권사 재경팀", en: "Securities Firm · Finance" },
  ...
  additionalExperiences: [
    {
      company: { ko: "개인 콘텐츠 채널 운영", en: "Personal Content Channel" },
  ...
  projects: [
    {
      ...
      result: {
        ko: "약 2주 프로모션에서 신규 고객 5천여 명 확보, 전월 대비 매출 133% 성장.",
        en: "A two-week promotion won ~5K new customers and grew revenue 133% month over month.",
      },
    },
    {
      ...
      result: {
        ko: "ROAS 86%→166%, 광고비 비중 116%→60%, 신규 리뷰 1,400여 건 확보.",
        en: "ROAS rose 86→166%, ad-cost ratio fell 116→60%, and 1,400+ new reviews were gathered.",
      },
    },
    {
      title: {
      ...
      approach: {
        ko: "USP 중심 상세페이지 리뉴얼, 썸네일 A/B 테스트, 카탈로그·현지화로 브랜드 자산 재정비.",
        en: "Rebuilt brand assets — USP-led detail pages, A/B-tested thumbnails, catalog renewal, and localization.",
      },
      result: {
  ...
  proofs: [
    ...
    { value: "1,400+", label: { ko: "신규 리뷰", en: "New Reviews" } },
    { value: "68×", label: { ko: "셀러 거래액 성장", en: "Seller GMV Growth" } },
    { value: "5K+", label: { ko: "신규 고객 · 2주", en: "New Customers · 2wks" } },
